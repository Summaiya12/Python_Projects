...
heading = Label(root,text="Timer" , font="arail 30 bold",bg="#000",fg="#ea3548")
...
def Timer():
    ...
    while times > -1:
        ...
        if(times==0):
            playsound("C:\\Users\\User\\Downloads\\ring.wav.mp3")
            sec.set("00")
            mins.set("00")
            hrs.set("00")
        times -= 1
...
Image1=PhotoImage(file="C:\\Users\\User\\Downloads\\brush.png")
button1=Button(root,image=Image1,bg="#000",bd=0,command=brush)
button1.place(x=7,y=300)

Image2=PhotoImage(file="C:\\Users\\User\\Downloads\\face.png")
button2=Button(root,image=Image2,bg="#000",bd=0,command=face)
button2.place(x=137,y=300)

Image3=PhotoImage(file="C:\\Users\\User\\Downloads\\eggs.png")
