...
def BMI():
    ...
    if bmi<=18.5:
        ...
        label2.config(text="Under Weight!!")
        label3.config(text="It indicates that a person is \n slightly overweight! \n A dcotor may advise to lose some")
    else:
        label2.config(text="Obes!")
        label3.config(text="Health may be at risk,if they donot lose \n lose weight")
image_icon=PhotoImage(file="C:\\Users\\User\\Downloads\\icon (3).png")
root.iconphoto(False,image_icon)
top=PhotoImage(file="C:\\Users\\User\\Downloads\\top (1).png")
top_image=Label(root,image=top,background="#f0f1f5")
top_image.place(x=-10,y=-10)
Label(root,width=72,height=18,bg="lightblue").pack(side=BOTTOM)
box=PhotoImage(file="C:\\Users\\User\\Downloads\\box (1).png")
Label(root,image=box).place(x=20,y=100)
Label(root,image=box).place(x=240,y=100)
scale=PhotoImage(file="C:\\Users\\User\\Downloads\\scale (1).png")
...
def slider_changed(event):
    ...
    img = (Image.open("C:\\Users\\User\\Downloads\\man (1).png"))
    reseized_image = img.resize((50,10+size))
    photo2=ImageTk.PhotoImage(reseized_image)
